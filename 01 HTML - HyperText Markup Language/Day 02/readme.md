...
HTML inline Element တွေဟာ style tag တွေအများဆုံးဖြစ်နေတတ်ပါတယ်။ `<b>`, `<i>` နှင့် အခြားသော style tag များစွာပါဝင်ပါတယ်။

## HTML - Anchor Link

Hyper link တွေ ဖန်တီးမို့ HTML Anchor tag `<a href='#'>` ကို အသုံးပြုပါတယ်။
